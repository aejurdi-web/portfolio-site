...
This isn't theoretical anymore. In 2026, custom ASIC server shipments are growing at roughly 44.6% year over year, nearly three times the 16.1% growth rate for GPU-based AI servers, according to TrendForce. TrendForce also projects custom silicon reaching close to 28% of the total AI server market, its highest share in years. The shift is happening in real shipment numbers, not just slideware.
